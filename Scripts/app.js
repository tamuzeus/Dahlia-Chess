...
function makePopUp(event){
    ...
    let popUpBodyText = "<h1 class='PopUpBodyText'>Escolha o lado:</h1>";
    ...
    let difficultyText = "<h2 class='PopUpBodyText' style='margin-top: 8px;'>Dificuldade:</h2>"

    let normal = "<button onclick=chooseDifficulty(2) class='ChooseSideButton DifficultyButton'> Nível Allan/Afrodite </button>";
    let tough = "<button onclick=chooseDifficulty(3) class='ChooseSideButton DifficultyButton' autofocus> Nível Pessoa Normal </button>";
    let hard = "<button onclick=chooseDifficulty(4) class='ChooseSideButton DifficultyButton'> Akuma (Demora mais responder) </button>";

    let themeText = "<h2 class='PopUpBodyText' style='margin-top: 8px;'>Escolha o tema:</h2>";
